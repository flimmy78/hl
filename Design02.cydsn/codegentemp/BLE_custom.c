...
const CYBLE_CUSTOMS_T cyBle_customs[0x01u] = {
    ...
    {
        0x000Eu, /* Handle of the Custom Service service */ 
        {

            /* TX to APP characteristic */
            {
                0x0010u, /* Handle of the TX to APP characteristic */ 
            ...
            /* RX from APP characteristic */
            {
                0x0013u, /* Handle of the RX from APP characteristic */ 
