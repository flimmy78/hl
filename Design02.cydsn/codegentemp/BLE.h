...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_GAPP_CONNECTION_INTERVAL_MAX      (0x0058u)
...
#define CYBLE_ADV_PKT_INDEX_BLUETOOTH_DEVICE_ADDRESS   (0x11u)

#define CYBLE_SCN_PKT_INDEX_LOCAL_NAME   (0x00u)
#define CYBLE_SCN_PKT_INDEX_BLUETOOTH_DEVICE_ADDRESS   (0x0Eu)
