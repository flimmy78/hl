...
// TCPWM_P4_v2_0(Clock_CheckTolerance=true, Clock_desired_freq=12, Clock_desired_freq_unit=6, Clock_divisor=1, Clock_FractDividerDenominator=0, Clock_FractDividerNumerator=0, Clock_FractDividerUsed=false, Clock_is_direct=false, Clock_is_divider=false, Clock_is_freq=true, Clock_minus_tolerance=5, Clock_ph_align_clock_id=, Clock_ph_align_clock_name=, Clock_plus_tolerance=5, Clock_source_clock_id=, Clock_source_clock_name=, PinVisibility_index=false, PinVisibility_kill=false, PinVisibility_phiA=false, PinVisibility_phiB=false, PinVisibility_switch=false, PWMCompare=0, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=125, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=65535, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=7, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, TermMode_capture=0, TermMode_cc=0, TermMode_clock=0, TermMode_count=0, TermMode_interrupt=0, TermMode_line=0, TermMode_line_n=0, TermMode_ov=0, TermMode_reload=0, TermMode_start=0, TermMode_stop=0, TermMode_un=0, TermModeStates=, TermVisibility_capture=false, TermVisibility_cc=true, TermVisibility_clock=true, TermVisibility_count=false, TermVisibility_interrupt=true, TermVisibility_line=true, TermVisibility_line_n=true, TermVisibility_ov=true, TermVisibility_reload=false, TermVisibility_start=false, TermVisibility_stop=false, TermVisibility_un=true, CY_API_CALLBACK_HEADER_INCLUDE=, CY_COMPONENT_NAME=TCPWM_P4_v2_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=PWM, CY_INSTANCE_SHORT_NAME=PWM, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=PWM, )
...
module BLE_v2_30_4 (
	...
	cy_clock_v1_0
		#(.id("beed30e2-59c7-4d9d-bfc8-89e47ec1791e/5ae6fa4d-f41a-4a35-8821-7ce70389cb0c"),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d5939366-6c16-43cd-a4ff-60f09db26857"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Beep_Ctrl_net;
	wire [0:0] tmpFB_0__Beep_Ctrl_net;
	wire [0:0] tmpIO_0__Beep_Ctrl_net;
	wire [0:0] tmpINTERRUPT_0__Beep_Ctrl_net;
	electrical [0:0] tmpSIOVREF__Beep_Ctrl_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Beep_Ctrl
		 (.oe(tmpOE__Beep_Ctrl_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Beep_Ctrl_net[0:0]}),
		  .io({tmpIO_0__Beep_Ctrl_net[0:0]}),
		  .siovref(tmpSIOVREF__Beep_Ctrl_net),
		  .interrupt({tmpINTERRUPT_0__Beep_Ctrl_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Beep_Ctrl_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("8ff8fd3f-beb9-4ff7-be41-2352b2195181"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("268b8841-40e0-45c5-aa0e-44be82e633d9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("98ed5301-528c-49d0-b52a-e7f94c6da5a7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__POWERON_IN_net;
	wire [0:0] tmpFB_0__POWERON_IN_net;
	wire [0:0] tmpIO_0__POWERON_IN_net;
	wire [0:0] tmpINTERRUPT_0__POWERON_IN_net;
	electrical [0:0] tmpSIOVREF__POWERON_IN_net;

	cy_psoc3_pins_v1_10
		#(.id("b1334540-eeb6-4e63-bd13-f5b5991f6a57"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		POWERON_IN
		 (.oe(tmpOE__POWERON_IN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__POWERON_IN_net[0:0]}),
		  .io({tmpIO_0__POWERON_IN_net[0:0]}),
		  .siovref(tmpSIOVREF__POWERON_IN_net),
		  .interrupt({tmpINTERRUPT_0__POWERON_IN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__POWERON_IN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("3dd6dd5e-6646-4bdc-af91-5f9c6867e133"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("4c8e800e-c2a3-43bf-b5e3-bd6641b669d0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__POWERON_OUT_net;
	wire [0:0] tmpFB_0__POWERON_OUT_net;
	wire [0:0] tmpIO_0__POWERON_OUT_net;
	wire [0:0] tmpINTERRUPT_0__POWERON_OUT_net;
	electrical [0:0] tmpSIOVREF__POWERON_OUT_net;

	cy_psoc3_pins_v1_10
		#(.id("996273ad-1967-4a3b-9ae0-0640eac2b5ba"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		POWERON_OUT
		 (.oe(tmpOE__POWERON_OUT_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__POWERON_OUT_net[0:0]}),
		  .io({tmpIO_0__POWERON_OUT_net[0:0]}),
		  .siovref(tmpSIOVREF__POWERON_OUT_net),
		  .interrupt({tmpINTERRUPT_0__POWERON_OUT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__POWERON_OUT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    TCPWM_P4_v2_0_1 System_Timer (
        .stop(1'b0),
        .reload(1'b0),
        .start(1'b0),
        .count(1'b1),
	...
	cy_clock_v1_0
		#(.id("ce535217-eb70-4083-a445-44c3f37d1928"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__BAT_AD_net;
	wire [0:0] tmpFB_0__BAT_AD_net;
	wire [0:0] tmpIO_0__BAT_AD_net;
	wire [0:0] tmpINTERRUPT_0__BAT_AD_net;
	electrical [0:0] tmpSIOVREF__BAT_AD_net;

	cy_psoc3_pins_v1_10
		#(.id("9231b80c-83cf-49ca-8373-e33600a11093"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		BAT_AD
		 (.oe(tmpOE__BAT_AD_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__BAT_AD_net[0:0]}),
		  .analog({Net_3582}),
		  .io({tmpIO_0__BAT_AD_net[0:0]}),
		  .siovref(tmpSIOVREF__BAT_AD_net),
		  .interrupt({tmpINTERRUPT_0__BAT_AD_net[0:0]}),
		  .annotation({Net_3570}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__BAT_AD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_SEQ_P4_v2_20_2 ADC (
        .Vref(Net_3577),
        .sdone(Net_3578),
        .eoc(Net_3579),
        .aclk(1'b0),
	...
	cy_clock_v1_0
		#(.id("87c58a9a-c7d2-4469-a4fb-5c6825b4a426"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
    ...
    cy_annotation_universal_v1_0 VDD_3V3 (
        .connect({
            Net_4445
        })
    );
    defparam VDD_3V3.comp_name = "Power_v1_0";
    defparam VDD_3V3.port_names = "T1";
    defparam VDD_3V3.width = 1;

    cy_annotation_universal_v1_0 BEEP (
        .connect({
            Net_4438,
            Net_4445
        })
    );
    defparam BEEP.comp_name = "Speaker_v1_0";
    defparam BEEP.port_names = "T1, T2";
    defparam BEEP.width = 2;
